...
// const Upload: React.FC = () => {
//     const navigate = useNavigate();
//     const { files } = useStoredFiles(); //  access uploaded files
//     const selectedFileId = files.length > 0 ? files[0].id : null; // pick first file for now
...
//                 <div className="flex items-center justify-between mt-4 w-full">
//                     <h1 className="font-bold text-4xl text-left w-full">Your files</h1>
//                     {/* <Button onClick={() => navigate(`/ocel/ocel-visualization?fileId=${selectedFileId}`)} className="bg-blue-500">
//                         <CircleArrowRight />
//                         <p>Explore Data</p>
//                     </Button> */}
//                      <Button onClick={() => navigate('/data/pipeline')} className="bg-blue-500">
